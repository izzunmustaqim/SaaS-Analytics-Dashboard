  ...
  return (
    <div className="space-y-6 max-w-[1400px]">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Deep dive into user engagement and conversion metrics</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <Card className="border-border bg-card">
          <CardHeader>
            ...
            <CardDescription>Users and sessions over 8 weeks</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border bg-card">
          <CardHeader>
            ...
            <CardDescription>From visitors to retained customers</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={280}>
